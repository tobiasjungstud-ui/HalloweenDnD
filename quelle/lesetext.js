...
T.KAPITEL.forEach((k,i)=>{
  ...
  k.bloecke.forEach(b=>{
    ...
    switch(b.t){
      ...
      case "aufgabe":
        kinder.push(...kasten([[...etikett("AUFGABE:","3A5A4C"),new TextRun({text:ohneHtml(b.text)+(b.blatt?"  →  "+b.blatt:""),font:"Georgia",size:19})]],gruen,"74B094")); break;
      case "regie":
      ...
      case "fa":
        kinder.push(...kasten([[...etikett((b.titel||"WENN SIE FRAGEN").toUpperCase()+" (NUR DM)","555555")],
