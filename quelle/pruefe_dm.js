...
const WEGE=["weg_a","weg_b","weg_c"], TUEREN=["bibliothek","kapelle","kueche"], WAHLEN=["e3_raus","e3_buch","e3_pakt"], AUSGAENGE=["ausgang_tot","ausgang_vertrag","ausgang_flucht"];
...
for(const weg of WEGE) for(const anneke of [false,true]) for(const tuer of TUEREN) for(const wahl of WAHLEN)
  for(const scheitert of (wahl==="e3_pakt"?[false,true]:[false])) for(const ausgang of AUSGAENGE)
   for(const wache of (weg==="weg_c"?[false]:[false,true]))
    pfade.push({weg,anneke,tuer,wahl,scheitert,ausgang,wache});
...
const durchlaeufe = [
  ["Standard: Strasse, Bibliothek, Angebot, Vertrag",           {weg:"weg_a",anneke:true, tuer:"bibliothek",wahl:"e3_pakt",scheitert:false,ausgang:"ausgang_vertrag"}],
  ["Gegenteil: Stollen, Küche, hinaustragen, tot",              {weg:"weg_b",anneke:false,tuer:"kueche",    wahl:"e3_raus",scheitert:false,ausgang:"ausgang_tot"}],
  ["Wechselnd: Kutsche, Kapelle mit Namen, Buch, Flucht",       {weg:"weg_c",anneke:true, tuer:"kapelle",   wahl:"e3_buch",scheitert:false,ausgang:"ausgang_flucht"}],
  ["Alles entdeckt: Stollen, Kapelle mit Namen, Angebot, Vertrag",{weg:"weg_b",anneke:true, tuer:"kapelle", wahl:"e3_pakt",scheitert:false,ausgang:"ausgang_vertrag"}],
  ["Nichts entdeckt: Strasse, Kapelle ohne Namen, hinaustragen, Flucht",{weg:"weg_a",anneke:false,tuer:"kapelle",wahl:"e3_raus",scheitert:false,ausgang:"ausgang_flucht"}],
  ["Verhandlung scheitert: Kutsche, Küche, Angebot→Kampf, tot", {weg:"weg_c",anneke:false,tuer:"kueche",    wahl:"e3_pakt",scheitert:true, ausgang:"ausgang_tot"}],
  ["Sonderfall: Buch verbrannt, Kapelle nie betreten, Vertrag",   {weg:"weg_a",anneke:true, tuer:"bibliothek",wahl:"e3_buch",scheitert:false,ausgang:"ausgang_vertrag"}],
];
